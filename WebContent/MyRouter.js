...
jQuery.sap.declare("sap.ui.demo.Northwind.MyRouter");

sap.ui.core.routing.Router.extend("sap.ui.demo.Northwind.MyRouter", {
	...
	myNavBack: function(sRoute, mData) {
		...
		var sPrevHash = oHistory.gerPreviousHash();
